//
//  riwayatpesananstatusFailed.swift
//  UI_Study
//
...
struct riwayatpesananstatusFailed: View {
    ...
    var body: some View {
        VStack {
            ZStack{
                ...
                VStack{
                    listriwayatpesananstatusFailed()
...
struct listriwayatpesananstatusFailed: View {
    @Environment(\.presentationMode) var presentationMode: Binding<PresentationMode>
...
struct riwayatpesananstatusFailed_Previews: PreviewProvider {
    static var previews: some View {
        riwayatpesananstatusFailed()
    }
}
