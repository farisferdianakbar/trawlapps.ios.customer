//
//  riwayatpesananstatusFinish.swift
//  UI_Study
//
...
struct riwayatpesananstatusFinish: View {
    ...
    var body: some View {
        VStack {
            ZStack{
                ...
                VStack{
                    listriwayatpesananstatusFinish()
...
struct listriwayatpesananstatusFinish: View {
    @Environment(\.presentationMode) var presentationMode: Binding<PresentationMode>
...
struct listriwayatpesananstatusFinish_Previews: PreviewProvider {
    static var previews: some View {
        riwayatpesananstatusFinish()
    }
}
